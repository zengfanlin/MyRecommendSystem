...
object ConnHelper extends Serializable {
  // 懒变量定义，使用的时候才初始化
  lazy val jedis = new Jedis("cdh03")
  lazy val mongoClient = MongoClient(MongoClientURI("mongodb://cdh03:27017/recommender"))
}
  ...
  def main(args: Array[String]): Unit = {
    ...
    val kafkaStream = KafkaUtils
      .createDirectStream[String, String](ssc,
        ...
        ConsumerStrategies.Subscribe[String, String](Set(config("kafka.topic")), kafkaParam))
